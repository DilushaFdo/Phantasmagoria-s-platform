...
// Set up the transporter to send emails using SMTP settings from our .env file
...
// Sends the verification token to a new user's email
...
// Sends the reset password token to a user
...
// Sends a congrats email if they won the daily bid
...
// Sends an update if they lost the daily bid
